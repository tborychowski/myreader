...
Completely rewritten from scratch in Laravel 5 & ES2015 (with the help from babel & webpack).
...
### Features
- extremely lightweight (takes only ?MB on disc (prod. version) including external libraries, excluding DB & cache)
